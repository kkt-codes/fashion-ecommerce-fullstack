...
// This component protects routes that should only be accessible to authenticated 'Buyer' users.
...
export default function BuyerProtectedRoute({ children }) {
  ...
  // If the user is not authenticated OR if their role is not 'Buyer',
  ...
  if (!isAuthenticated || userRole !== 'Buyer') {
    ...
    // If authenticated but with the wrong role (e.g., a 'Seller' trying to access a 'Buyer' page),
  ...
  // If loading is complete, the user is authenticated, AND their role is 'Buyer',
