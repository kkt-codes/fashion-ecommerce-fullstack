...
const SettingRow = ({ id, name, checked, onChange, label, description }) => (
    <div className="flex items-center justify-between pb-4 border-b border-gray-200">
        <div>
            <label htmlFor={id} className="text-lg font-medium text-gray-900">{label}</label>
...
const SupportEmailInput = ({ value, onChange }) => (
    <div>
    ...
    const renderContent = () => {
        ...
        return (
            <div className="bg-white rounded-lg shadow-xl p-8 space-y-8">
                ...
                />
                <SupportEmailInput value={settings.supportEmail} onChange={handleChange} />
                <SaveButton isSaving={isSaving} onClick={handleSaveSettings} />
            </div>
        );
    };
